...
export default function PhysicalTherapy() {
  ...
  const [customerValue, setCustomerValue] = useState(220);
    ...
    >
      ...
      >
        <div>
          ...
          <small>Physical Therapy Missed Call AI</small>
        </div>
      ...
      >
        ...
        >
          Recover Missed Physical Therapy Patients Automatically
        </h1>
        ...
        >
          ...
          for physical therapy clinics 24/7.
        </p>
      </section>
      ...
      <section style={{ padding: "0 8% 60px" }}>
        ...
        >
          <h2 style={{ textAlign: "center" }}>
            Physical Therapy Revenue Recovery Calculator
          </h2>
      ...
      >
        <h2>What Physical Therapists Use It For</h2>
