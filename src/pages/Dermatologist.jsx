    ...
    >
      ...
      >
        <div>
          ...
          <small>Dermatology Missed Call AI</small>
        </div>
      ...
      >
        ...
        >
          Recover Missed Dermatology Patients Automatically
        </h1>
        ...
        >
          AI follows up missed callers, answers questions,
          books appointments, and recovers lost revenue
          for dermatology clinics 24/7.
        </p>
      </section>
      ...
      <section style={{ padding: "0 8% 60px" }}>
        ...
        >
          <h2 style={{ textAlign: "center" }}>
            Dermatology Revenue Recovery Calculator
          </h2>
          ...
          <p>
            Average Patient Value: ${customerValue}
          </p>
      ...
      >
        <h2>What Dermatologists Use It For</h2>
        ...
        >
          <div>New Patient Booking</div>
          <div>Skin Consultation Scheduling</div>
          <div>Cosmetic Procedure Questions</div>
