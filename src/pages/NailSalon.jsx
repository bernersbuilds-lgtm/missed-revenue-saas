...
export default function NailSalon() {
  ...
  const [customerValue, setCustomerValue] = useState(80);
    ...
    >
      ...
      >
        <div>
          ...
          <small>Nail Salon Missed Call AI</small>
        </div>
      ...
      <section style={{ padding: "70px 8%", textAlign: "center" }}>
        ...
        >
          Recover More Nail Salon Clients Automatically
        </h1>
      ...
      <section style={{ padding: "0 8% 60px" }}>
        ...
        >
          <h2 style={{ textAlign: "center" }}>
            Nail Salon Revenue Recovery Calculator
          </h2>
