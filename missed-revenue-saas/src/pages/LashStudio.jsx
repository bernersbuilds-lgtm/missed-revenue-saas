    ...
    <div className="page">
      <section className="hero">
        <div className="heroLeft">
          <div className="tag">LASH STUDIO BOOKING AUTOMATION</div>
          <h1>Stop losing lash appointments from missed calls.</h1>
          <p className="heroText">
            Automatically text missed callers your booking link so your
            studio can keep appointments coming in.
          </p>
